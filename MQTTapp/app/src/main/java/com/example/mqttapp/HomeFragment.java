...
public class HomeFragment extends Fragment {
    ...
    private static boolean homeFragmentInitFlag;
    private MqttClient client;

    public Handler handler;
    private final String host = "tcp://39.98.92.2:1883";
    private final String mqtt_id = "android";
    private final String userName = "jojo";
    private final String passWord = "harmsworth";
    private final String mqtt_sub_topic = "pcTopic";
    ...
    private final BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null && !fragmentViewDestroyFlag) {
                ...
                message.what = 3;
                message.obj = intent.getStringExtra(KEY_RESULT);
